...
class HomeClubRecyclerViewAdapter(var data: ArrayList<ClubListResponse>, val mContext1: Application) :
    RecyclerView.Adapter<HomeClubRecyclerViewAdapter.MyViewHolder>(){
