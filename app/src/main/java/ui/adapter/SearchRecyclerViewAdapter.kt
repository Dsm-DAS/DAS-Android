...
class SearchRecyclerViewAdapter(var data: ArrayList<RecruitmentListResponse>,val mContext : Application) :
    RecyclerView.Adapter<SearchRecyclerViewAdapter.MyViewHolder>(){
