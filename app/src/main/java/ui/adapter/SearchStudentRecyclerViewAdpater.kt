...
class SearchStudentRecyclerViewAdpater (var data: ArrayList<UserListData>, val mContext2: Application) :
    RecyclerView.Adapter<SearchStudentRecyclerViewAdpater.MyViewHolder>(){
